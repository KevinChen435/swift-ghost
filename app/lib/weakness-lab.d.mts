...
export type WeaknessEvidenceKind = "learning-event" | "solution-review" | "assessment" | "mock-debrief" | "transfer";
...
export function buildWeaknessLab(input?: { items?: PracticeItem[]; attempts?: AttemptRecord[]; submissionReceipts?: SubmissionReceipt[]; learningEvents?: LearningEvent[]; solutionReviews?: SolutionReviewRecord[]; assessmentReports?: AssessmentReport[]; sessionHistory?: SessionHistoryRecord[]; transferRecords?: TransferRecord[]; itemSignals?: Record<string, { due?: boolean; completions?: number; owned?: boolean; recommendedStage?: number }>; now?: string | number | Date }): WeaknessLabModel;
