...
import type { AttemptClosureRecord, AttemptClosureWorkspace } from "./attempt-closures.mjs";
...
export type WeaknessEvidenceKind = "learning-event" | "solution-review" | "assessment" | "mock-debrief" | "attempt-closure" | "transfer" | "pattern-decision" | "test-design";
...
export function buildWeaknessLab(input?: { items?: PracticeItem[]; attempts?: AttemptRecord[]; typingProgress?: TypingProgressionWorkspace; submissionReceipts?: SubmissionReceipt[]; learningEvents?: LearningEvent[]; solutionReviews?: SolutionReviewRecord[]; assessmentReports?: AssessmentReport[]; sessionHistory?: SessionHistoryRecord[]; attemptClosures?: AttemptClosureWorkspace | AttemptClosureRecord[]; transferRecords?: TransferRecord[]; conceptTransferAttempts?: ConceptTransferAttempt[]; conceptTransferVariants?: readonly ConceptTransferVariant[]; patternDecisionAttempts?: PatternDecisionAttempt[]; patternLessons?: readonly PatternLesson[]; patternDecisionProbes?: readonly PatternDecisionProbe[]; testDesignAttempts?: TestDesignAttempt[]; testDesignProbes?: readonly TestDesignProbe[]; itemSignals?: Record<string, { due?: boolean; completions?: number; owned?: boolean; recommendedStage?: number }>; now?: string | number | Date }): WeaknessLabModel;
