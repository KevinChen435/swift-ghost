...
export function createStudyCollection(workspace: StudyWorkspace, input: { title: string; description?: string; outcome?: string; itemIds: ItemId[]; source?: "builtin" | "custom" }, options?: { id?: string; now?: string | Date | number }): StudyWorkspace;
