...
export const PYTHON_PROBLEMS: PythonProblem[] = [
  {
    ...
    verification: {
      ...
      cases: [
        ...
        {
          name: "normalizes a single mixed-case word",
          args: [["  MiXeD  "]],
          expected: ["mixed", 1],
          comparator: "deepEqual",
        },
  ...
  },
  {
    ...
    verification: {
      ...
      cases: [
        ...
        {
          name: "preserves distinct negative and zero values",
          args: [[0, -1, 0, -2, -1]],
          expected: [0, -1, -2],
          comparator: "deepEqual",
        },
  ...
  },
  {
    ...
    verification: {
      ...
      cases: [
        ...
        {
          name: "reports mismatches at both sequence boundaries",
          args: [["a", "b", "c"], ["x", "b", "y"]],
          expected: [
            [0, "a", "x"],
            [2, "c", "y"],
  ...
  },
  {
    ...
    verification: {
      ...
      cases: [
        ...
        {
          name: "keeps stable order when normalized sort keys tie",
          args: [
            [
              ["amy", 5],
              ["Amy", 5],
...
def breadth_first_order(graph: dict[str, list[str]], start: str) -> list[str]:
    ...
    verification: {
      ...
      cases: [
        ...
        {
          name: "ignores a self-loop while reaching an implicit leaf",
          args: [{ a: ["a", "b"] }, "a"],
          expected: ["a", "b"],
          comparator: "deepEqual",
        },
...
def next_tasks(tasks: list[tuple[int, int, str]], limit: int) -> list[str]:
    ...
    verification: {
      ...
      cases: [
        ...
        {
          name: "falls through to task name when priority keys tie",
          args: [
            [
              [1, 0, "z"],
              [1, 0, "a"],
  ...
  },
  {
    ...
    verification: {
      ...
      cases: [
        ...
        {
          name: "preserves repeated values with leading zeroes",
          args: [[" 05 ", "005", "100"]],
          expected: [[5, 5, 100], 10050],
          comparator: "deepEqual",
        },
      ],
    },
...
def summarize_events(
    ...
    verification: {
      ...
      cases: [
        ...
        {
          name: "counts repeated events without collapsing owner history",
          args: [
            [
              ["ana", "open"],
              ["ana", "open"],
...
class Solution:
    ...
    verification: {
      ...
      cases: [
        ...
        {
          name: "preserves duplicate words inside an anagram group",
          args: [["a", "a", "b"]],
          expected: [["a", "a"], ["b"]],
          comparator: "unorderedNested",
        },
  ...
  },
  {
    ...
    verification: {
      ...
      cases: [
        ...
        {
          name: "tracks signs across several negative factors",
          args: [[-1, 2, -3, 4]],
          expected: [-24, 12, -8, 6],
          comparator: "deepEqual",
        },
  ...
  },
  {
    ...
    verification: {
      ...
      cases: [
        ...
        {
          name: "compares digits as significant characters",
          args: ["0P"],
          expected: false,
          comparator: "deepEqual",
        },
  ...
  },
  {
    ...
    verification: {
      ...
      cases: [
        ...
        {
          name: "deduplicates repeated values around one valid triple",
          args: [[-2, 0, 0, 2, 2]],
          expected: [[-2, 0, 2]],
          comparator: "unorderedNested",
        },
  ...
  },
  {
    ...
    verification: {
      ...
      cases: [
        ...
        {
          name: "retains the best suffix after staggered repeats",
          args: ["tmmzuxt"],
          expected: 5,
          comparator: "deepEqual",
        },
...
class Solution:
    ...
    verification: {
      ...
      cases: [
        ...
        {
          name: "returns empty for an empty requirement",
          args: ["anything", ""],
          expected: "",
          comparator: "deepEqual",
        },
  ...
  },
  {
    ...
    verification: {
      ...
      cases: [
        ...
        {
          name: "rejects a closer before any opener",
          args: ["]"],
          expected: false,
          comparator: "deepEqual",
        },
  ...
  },
  {
    ...
    verification: {
      ...
      cases: [
        ...
        {
          name: "waits across equal temperatures for a strict increase",
          args: [[70, 70, 71]],
          expected: [2, 1, 0],
          comparator: "deepEqual",
        },
  ...
  },
  {
    ...
    verification: {
      ...
      cases: [
        ...
        {
          name: "finds the target in a one-element array",
          args: [[5], 5],
          expected: 0,
          comparator: "deepEqual",
        },
  ...
  },
  {
    ...
    verification: {
      ...
      cases: [
        ...
        {
          name: "handles a dominant pile at the tightest deadline",
          args: [[1, 1, 1, 999999999], 4],
          expected: 999999999,
          comparator: "deepEqual",
        },
      ],
  ...
  },
  {
    ...
    verification: {
      ...
      cases: [
        ...
        {
          name: "reverses duplicate and negative node values",
          args: [[0, -1, -1, 2]],
          expected: [2, -1, -1, 0],
          argCodecs: ["linkedList"],
          outputCodec: "linkedList",
  ...
  },
  {
    ...
    verification: {
      ...
      cases: [
        ...
        {
          name: "appends a wholly larger sorted list",
          args: [[-3, -1], [0, 2]],
          expected: [-3, -1, 0, 2],
          argCodecs: ["linkedList", "linkedList"],
          outputCodec: "linkedList",
  ...
  },
  {
    ...
    verification: {
      ...
      cases: [
        ...
        {
          name: "rejects an empty linked list",
          args: [
            {
              values: [],
              pos: -1,
  ...
  },
  {
    ...
    verification: {
      ...
      cases: [
        ...
        {
          name: "counts every level in a left-skewed tree",
  ...
  },
  {
    ...
    verification: {
      ...
      cases: [
        ...
        {
          name: "accepts a valid right-skewed BST",
          args: [[0, null, 1, null, 2]],
          expected: true,
          argCodecs: ["binaryTree"],
          comparator: "deepEqual",
        },
...
class Solution:
    ...
    verification: {
      ...
      cases: [
        ...
        {
          name: "preserves left-to-right order in a sparse level",
...
class Solution:
    ...
    verification: {
      ...
      cases: [
        ...
        {
          name: "returns the minimum when k equals the array length",
          args: [[-2, -1, -3], 3],
          expected: -3,
          comparator: "deepEqual",
        },
...
class Solution:
    ...
    verification: {
      ...
      cases: [
        ...
        {
          name: "selects a negative value with uniquely highest frequency",
          args: [[-1, -1, -2, -2, -2, 3], 1],
          expected: [-2],
          comparator: "unordered",
        },
  ...
  },
  {
    ...
    verification: {
      ...
      cases: [
        ...
        {
          name: "absorbs unsorted intervals nested inside a covering range",
          args: [
            [
              [5, 7],
              [1, 10],
  ...
  },
  {
    ...
    verification: {
      ...
      cases: [
        ...
        {
          name: "inserts a disjoint interval before every existing interval",
          args: [
            [
              [3, 5],
              [7, 9],
  ...
  },
  {
    ...
    verification: {
      ...
      cases: [
        ...
        {
          name: "treats diagonal land cells as separate islands",
          args: [
            [
              ["1", "0"],
              ["0", "1"],
...
class Solution:
    ...
    verification: {
      ...
      cases: [
        ...
        {
          name: "rejects a self-dependent course among disconnected courses",
          args: [3, [[1, 1]]],
          expected: false,
          comparator: "deepEqual",
        },
  ...
  },
  {
    ...
    verification: {
      ...
      cases: [
        ...
        {
          name: "combines direct and repeated-candidate solutions",
          args: [[3, 4, 8], 8],
          expected: [[4, 4], [8]],
          comparator: "unorderedNested",
        },
  ...
  },
  {
    ...
    verification: {
      ...
      cases: [
        ...
        {
          name: "finds a word by traversing a row backward",
          args: [[["A", "B", "C"]], "CBA"],
          expected: true,
          comparator: "deepEqual",
        },
  ...
  },
  {
    ...
    verification: {
      ...
      cases: [
        ...
        {
          name: "reaches the end exactly across trailing zeroes",
          args: [[2, 0, 0]],
          expected: true,
          comparator: "deepEqual",
        },
  ...
  },
  {
    ...
    verification: {
      ...
      cases: [
        ...
        {
          name: "handles the upper recurrence boundary",
          args: [45],
          expected: 1836311903,
          comparator: "deepEqual",
        },
  ...
  },
  {
    ...
    verification: {
      ...
      cases: [
        ...
        {
          name: "avoids a locally tempting adjacent pair",
          args: [[2, 1, 1, 2]],
          expected: 4,
          comparator: "deepEqual",
        },
